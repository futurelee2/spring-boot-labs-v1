...
public interface PostRepository extends JpaRepository<com.example.ch4codeyourself.v5.domain.Post, Long>, PostQueryRepository {
    ...
    Page<com.example.ch4codeyourself.v5.domain.Post> findByTitleContaining(String keyword, Pageable pageable); // 예약어
    ...
    Page<com.example.ch4codeyourself.v5.domain.Post> searchByTitleContainingAndAuthor(@Param("keyword")  String keyword , @Param("author") String author, Pageable pageable);
